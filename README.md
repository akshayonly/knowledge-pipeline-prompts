...
A collection of **nine** structured AI prompt templates that form a five-stage workflow for turning raw papers, videos, and lectures into processed, actionable knowledge.
...
1.  Run `analysis/scaffolder.md` — build the scaffolding and surface hidden assumptions.
...
[The 9-Prompt System That Turns Raw Papers, Videos, and Lectures Into Structured Knowledge](https://www.google.com/search?q=%23).
